...
there are `r format(ncol(counts), big.mark = ',')` cells.
>
...
We now have a Seurat object with `r format(nrow(liver), big.mark = ',')` genes and `r format(ncol(liver), big.mark = ',')` cells.
...
```{r filter_umi,fig.height=4,fig.width=6,fig.alt=""}
